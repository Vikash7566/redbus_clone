const initialSeats = [
  ...
  { id: 14, number: 'D2', isBooked: true, isFemaleOnly: false },
  ...
  { id: 32, number: 'H4', isBooked: false, isFemaleOnly: true },
  { id: 33, number: 'I1', isBooked: false, isFemaleOnly: true },
  { id: 34, number: 'I2', isBooked: false, isFemaleOnly: true },
  { id: 35, number: 'I3', isBooked: true, isFemaleOnly: true },
  { id: 36, number: 'I4', isBooked: false, isFemaleOnly: true },
  { id: 37, number: 'J1', isBooked: false, isFemaleOnly: true },
  { id: 38, number: 'J2', isBooked: true, isFemaleOnly: true },
  { id: 39, number: 'J3', isBooked: false, isFemaleOnly: true },
  { id: 40, number: 'J4', isBooked: false, isFemaleOnly: true },
  { id: 41, number: 'K1', isBooked: false, isFemaleOnly: true },
  { id: 42, number: 'K2', isBooked: false, isFemaleOnly: true },
  { id: 43, number: 'K3', isBooked: false, isFemaleOnly: true },
  { id: 44, number: 'K4', isBooked: false, isFemaleOnly: true },
  { id: 45, number: 'L1', isBooked: false, isFemaleOnly: true },
  { id: 46, number: 'L2', isBooked: true, isFemaleOnly: true },
  { id: 47, number: 'L3', isBooked: false, isFemaleOnly: true },
  { id: 48, number: 'L4', isBooked: false, isFemaleOnly: true },
  ...
  { id: 74, number: 'S2', isBooked: false, isFemaleOnly: true },
  { id: 75, number: 'S3', isBooked: true, isFemaleOnly: true },
  { id: 76, number: 'S4', isBooked: false, isFemaleOnly: true },
  { id: 77, number: 'T1', isBooked: false, isFemaleOnly: true },
  { id: 78, number: 'T2', isBooked: false, isFemaleOnly: true },
  { id: 79, number: 'T3', isBooked: false, isFemaleOnly: true },
